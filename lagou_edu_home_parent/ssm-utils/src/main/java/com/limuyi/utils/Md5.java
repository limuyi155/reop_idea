...
public class Md5 {
    ...
    public final static  String md5key = "limuyi";
    /**
     * MD5方法
    ...
    public static void main(String[] args) throws Exception {
        ...
        String lagou = Md5.md5("123456", "limuyi");
        ...
        boolean verify = Md5.verify("123456", "limuyi", "f00485441dfb815c75a13f3c3389c0b9");
